...
struct MemoryGameModel<CardContent> where CardContent: Equatable {
    ...
    struct Card: Identifiable {
        ...
        //    this could matching bonus points
        //    if the user matches the card
        //    before a cert amount fo time passes during which the card is face up
            
        //    can be zero which means "no bonus available" or this card
            var bonusTimeLimit: TimeInterval = 6
            
        //    how long this card is face up
        ...
        //    last time this card was turned face uo (and is still face up)
            var lastFaceUpDate: Date?
        //    the acumulated time this card has been face up in the past
        //    (i.e. not including the current time it`s been face up if it is currently so)
            var pastFaceUpTime: TimeInterval = 0
            
        //    how much time left the bonus opportunity runs out
...
//        whether we re currently face up, unmatched and have not yet used up the bonus window
